...
const { cloneRepository: cloneRepository_, buildAndRunDocker: buildAndRunDocker_, } = require('./buildSources');
async function installDependencies(productId, resourcesPath, statusCallback) {
    try {
