...
export const CRM_SERVER = 'http://localhost:8080/api';

export const REMOTE_URL = '127.0.0.1';
export const REMOTE_WSS = 'ws://127.0.0.1';
export const REMOTE_WSS_URL = REMOTE_WSS;
export const INFLUXDB_URL = 'http://localhost:8086';
export const INFLUXDB_ORG = 'Opportunities';
export const INFLUXDB_BUCKET = 'Opportunities';
export const TELEGRAF_CLIENT = '127.0.0.1';
export const POSITION_MANAGER_API = 'http://localhost:3003';
export const SUPABASE_URL = 'https://yhotbknfiebbflhovpws.supabase.co';
export const SUPABASE_KEY =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inlob3Ria25maWViYmZsaG92cHdzIiwicm9sZSI6ImFub24iLC';
